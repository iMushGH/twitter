...
export default function Sidebar() {
  return (
    <div className="hidden sm:inline sm:w-[70px] flex-col items-center justify-center lg:items-start p-2 border-r border-gray-200 lg:w-[250px] fixed h-full z-10">
      <Image
        src="https://logos-world.net/wp-content/uploads/2023/08/X-Logo.png"
        alt="logo"
        width={50}
        height={50}
        className="mb-8 hoverEffect  justify-center items-center"
      />
